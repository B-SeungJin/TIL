...
* 인프런 FullStack 강의 : 06.27 ~ 09.18
  ...
  - 09.07 ~ 09.18  '풀스택을 위한 탄탄한 프런트엔드 부트캠프 (HTML, CSS, 바닐라 자바스크립트 + ES6) [풀스택 Part2]'
## 06.27
...
## 09.18
* Javascript ES6문법을 작성하여 웹사이트에서 필요한 기능들을 작성하였다.
  - 웹페이지를 위로 올리는 버튼.
  - 카드를 양옆으로 움직이는 버튼. 
    + 위치 값을 이용하여 나타낼 수 있음.
* 모바일 환경에서 웹페이지를 수정하는 강의를 들었다.
  - 실습해보기.
* 백엔드와 프론트엔드 통신 기능을 익혔다.
* 인프런 강좌 수강 완료
  - '풀스택을 위한 탄탄한 프런트엔드 부트캠프 (HTML, CSS, 바닐라 자바스크립트 + ES6) [풀스택 Part2]' : 09.07 ~ 09.18  
